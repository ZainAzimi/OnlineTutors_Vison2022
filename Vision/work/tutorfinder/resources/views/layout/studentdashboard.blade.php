...
<!-- Mirrored from demo.dashboardpack.com/sales-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Jul 2022 15:23:56 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>

<meta charset="utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
<title>{{Session::get('sname')}} Persnol Student Dashboard</title>
<link rel="icon" href="{{ asset('images/logo/headlogo2.png')}}" type="image/x-icon">
...
<a href="index-2.html"><img src="{{ asset('images/logo/mainlogo2.png')}}" alt=""></a>
...
<ul id="sidebar_menu">
    <li class="">
        ...
        <div class="icon_menu">
            <i class="fa fa-home" style="color: #36a3f7; font-size: 25px;"></i>
        </div>
        <span>Home</span>
        </a>
        </li>
        <li class="">
            <a href="/myteachers" aria-expanded="false">
            <div class="icon_menu">
                <i class="fa fa-calendar-check" style="color: #36a3f7;font-size: 25px;"></i>
            </div>
            ...
            <li class="">
                <a href="calender.html" aria-expanded="false">
                <div class="icon_menu">
                    <i class="fa fa-graduation-cap" style="color: #36a3f7;font-size: 25px;"></i>
                </div>
                ...
                <li class="">
                    <a href="calender.html" aria-expanded="false">
                    <div class="icon_menu">
                        <i class="fa fa-book" style="color: #36a3f7;font-size: 25px;"></i>
                    </div>
                    <span>Payment</span>
                    </a>
                    </li>
...
<img src="{{asset('/images/logo/headlogo.png')}}" alt="#">
<div class="profile_info_iner">
<div class="profile_author_name">
<p>Student </p>
<h5>{{Session::get('sname')}}</h5>
</div>
<div class="profile_info_details">
<!-- <a href="#">My Profile </a>
<a href="#">Settings</a> -->
<a href="/studentlogout">Log Out </a>
</div>
</div>
</div>
</div>
...
<div class="row">
<div class="col-lg-12">
<div class="footer_iner textheader_notification_warp d-flex align-items-center-center">
<p>2020 © All Rights Reserved  || <a href="#"> </a><a href="#">  TutorFinder.com</a></p>
</div>
</div>
</div>
</div>
