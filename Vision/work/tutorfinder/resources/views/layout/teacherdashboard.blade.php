...
<title>{{Session::get('tname')}} Persnol Tutor Dashboard</title>
...
<ul id="sidebar_menu">
    <li class="">
        ...
        <li class="">
            <a href="/myprofile" aria-expanded="false">
            <div class="icon_menu">
            ...
            <li class="">
                <a href="/mystudents" aria-expanded="false">
                <div class="icon_menu">
...
<p>Tutor </p>
<h5>{{Session::get('tname')}}</h5>
</div>
<div class="profile_info_details">

<a href="/tutorlogout">Log Out </a>
</div>
</div>
</div>
</div>
